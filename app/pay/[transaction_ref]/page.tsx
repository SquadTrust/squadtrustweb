                  ...
                  <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-700 text-xs mt-1 leading-relaxed">
                        Your money is held securely in escrow. It will only be
                  ...
                  {timeLeft > 0 ? (
                    ...
                    <div className="text-center py-8 space-y-3">
                      ...
                      <p className="text-sm text-gray-500">
                        This secure payment link has expired. Please request a
                        new link from the seller.
                      </p>
                    </div>
                  )}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed px-4">
                      Your money is safe in escrow. The seller has been notified
              ...
              {escrow.status === "released" && (
                ...
                >
                  ...
                  <p className="text-gray-600 px-4">
                    Funds have been released to the seller. Thank you for using
                    SquadTrust!
                  </p>
                </motion.div>
              )}
