      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 sm:py-32 bg-gradient-to-b from-white to-gray-50/50">
        <div className="max-w-3xl space-y-8">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Protect your buyers and grow your business with zero-risk escrow
            payments, instant soft POS, and credit scoring. Powered by Squad.
          </p>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="flex flex-col items-start text-left space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Buyers pay into a secure Squad virtual account. Funds are only
              released when they confirm delivery.
            </p>
          </div>
          <div className="flex flex-col items-start text-left space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Turn your smartphone into a payment terminal. Accept contactless
          ...
          <div className="flex flex-col items-start text-left space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Build your Trust Score with every successful transaction to unlock
