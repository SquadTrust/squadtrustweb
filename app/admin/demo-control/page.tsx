...
export default function DemoControlPanel() {
  ...
  const [logs, setLogs] = useState<string[]>([
    "System initialized. Ready for demo.",
  ]);
  ...
  const triggerWebhook = () => {
    ...
    setTimeout(
      () => addLog("Webhook processed. Transaction status updated."),
      1000,
    );
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4">
        <form
          ...
          className="bg-gray-800 p-8 rounded-xl max-w-sm w-full space-y-6"
        >
        ...
        <header className="flex items-center gap-4 border-b border-gray-800 pb-6">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Operator panel for live pitch simulation.
            </p>
          </div>
        </header>
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">
                  Simulate incoming Dynamic VA payment
                </div>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-red-300/70">
                  Wipe all transactions and reset trust score
                </div>
              </div>
            </button>
          </div>
